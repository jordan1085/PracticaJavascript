...
function miFuncion2(valor, indice) {
    return valor.slice(0, indice);
}
// console.log(miFuncion2("Hola Mundo", 4));

// 3) Programa una función que dada una String te devuelva un Array de textos separados por cierto caracter, pe. miFuncion('hola que tal', ' ') devolverá ['hola', 'que', 'tal'].
function miFuncion3(valor, indice) {
    return valor.split(indice)
}
console.log(miFuncion3('hola que tal', ' '))

// 4) Programa una función que repita un texto X veces, pe. miFuncion('Hola Mundo', 3) devolverá Hola Mundo Hola Mundo Hola Mundo.

function miFuncion4(valor, indice) {
    return valor.repeat(indice)
}
...
function miFuncion6(valor, repeat)
